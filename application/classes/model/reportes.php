                    ...
                    FROM
                        ...
                        (SELECT 
                            s.nur,
                                ...
                                e.estado,
                                s.nombre_receptor,
                                DATE_FORMAT(s.fecha_emision, '%d/%m/%Y %H:%i:%s') AS fecha_emision,
                                s.fecha_recepcion,
                                s.oficial
                        FROM
                            seguimiento s
                ...
                */
                ...
                $sql = "SELECT
                        ...
                        FROM
                            ...
                            users u ON s.derivado_a = u.id
                        WHERE
                            u.nivel = 3 AND s.nur NOT LIKE 'I/%'
                                AND s.fecha_emision BETWEEN '$fecha1' AND '$fecha2'
                                AND s.id_seguimiento = 0
                                AND d.original = 1
                        ORDER BY fecha_emision DESC";
                ...
                */
                ...
                $sql = "SELECT 
                    ...
                    FROM
                        ...
                        INNER JOIN estados e ON s.estado = e.id
                        WHERE
                            s.fecha_emision BETWEEN '$fecha1' AND '$fecha2'
                        ORDER BY fecha_emision DESC) AS s ON d.nur = s.nur
                    WHERE
                        d.original = 1";
                */
        ...
        */
        ...
        $sql = "SELECT 
                ...
                FROM
                    ...
                    users u ON s.derivado_a = u.id
                WHERE
                    s.oficial = 1 AND s.id_de_oficina = '$oficina'
                        AND u.nivel = 3
                        AND s.fecha_emision BETWEEN '$fecha1' AND '$fecha2'
                        AND d.original = 1
                ORDER BY fecha_emision DESC";
