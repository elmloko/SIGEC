    ...
    */
    ...
    public function superior($id_user)
    {
        $sql = "  SELECT 
                ...
                FROM
                    ...
                    entidades e ON e.id = o.id_entidad
                WHERE
                    u.id = '$id_user' AND u.habilitado = '1'";
        return DB::query(1, $sql)->execute();
    }
    ...
    public function destinos_nuevosAdmin($id_user)
    {
        $sql = "  SELECT 
                ...
                FROM
                    users u
                        INNER JOIN
                    oficinas o ON o.id = u.id_oficina
                        INNER JOIN
    ...
    public function destinos_nuevos($id_user, $entidad)
    {
        ...
        */
        ...
        /*
        $sql="SELECT u.id,o.oficina,u.nombre,u.cargo,u.email,u.username,u.genero  FROM (
                    SELECT * FROM users u
                    WHERE u.id NOT IN (SELECT id_destino FROM destinatarios WHERE id_usuario='$id_user')
                    AND u.habilitado='1' AND u.id_entidad='$entidad' ) as u , oficinas o
