        ...
        $("#jqxgrid").jqxGrid(
                {
                    ...
                    columns: [
                        {text: 'Hoja Ruta', datafield: 'nur', width: '7%', },
                        //{text: 'HOJA DE RUTA', datafield: 'nur', width: '110'},
                        {text: 'TIPO DOC', datafield: 'tipo', width: '8%', },
                        {text: 'CITE DOCUMENTO', datafield: 'cite_original', width: '9%'},
                        {text: 'INSTITUCION DESTINATARIA', datafield: 'institucion_destinatario', width: '10%'},                        
                                                
                        {text: 'DESTINATARIO', datafield: 'destinatario', width: '13%'},
                        {text: 'INSTITUCION REM', datafield: 'institucion_remitente', width: '10%'},
                        {text: 'REMITENTE', datafield: 'remitente', width: '13%'},
                        {text: 'REFERENCIA', datafield: 'referencia', width: '18%'},
                        {text: 'FECHA', datafield: 'fecha_creacion', width: '5%', cellsformat: 'yyyy-MM-dd H:mm:ss', filtertype: 'date'},
                        ...
                        {text: '<img scr="asd">', datafield: 'edit', filtertype: 'none', width: '3%', cellsrenderer: editrenderer},
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class=" pull-right ">
            <a class="btn btn-sm btn-primary-dark" href="javascript:;" id="copia"><i class="fa fa-copy"></i> Crear Copia</a>
