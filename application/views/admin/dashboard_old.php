    ...
    $(document).ready(function () {
        ...
        function callAjax() {
            ...
            $.getJSON('/admin/ajax/bitacora', function (data) {
                $('table#vitacora tbody tr').remove();
                var cantidad=0;
                $.each(data, function (i, e) {
                    $('table#usuarios tbody').append('<tr><td>' + data[i].nombre + '</td><td>' + data[i].cargo + '</td><td>' + data[i].segundos + '</tr>');
                    cantidad++;
            ...
            <div class="card-body no-padding">
                <div class="alert alert-callout alert-info no-margin">
                    <a  href="/admin/entidades" style=" display: block;" class="mt">  <strong class="text-info text-lg">Entidades:  <i class="md md-audiotracs"></i></strong>                    
                        <h1 class="pull-right text-info"><i class="fa fa-home"></i></h1>
...
<div class="row">
    <div class=" col-sm-12 col-md-6">
        <div class="card style-default-dark card-underline">
            <div class="card-head">
                <header>Cantidad de usuarios conectados</header>
            </div>
            <div class="card-body height-12 ">
                <div id="users" class="height-6 ">
    ...
    <div class=" col-sm-12 col-md-6">
        <div class="card style-default-dark no-padding card-underline">
            <div class="card-head">
