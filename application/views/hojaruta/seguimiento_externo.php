...
<div class="card card-underline">
    ...
    <div class=" card-body">
                            ...
                            <div class="card-body small-padding">
                                ...
                                <div class="col-lg-2 col-md-2">
                                    ...
                                    $sql_observaciones = "  SELECT 
                                                                *,
                                                                DATE_FORMAT(fecha_observacion, '%d/%m/%Y %H:%i:%s') AS fecha_observacion_formateada
                                                            FROM
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <input type="hidden" id="id_seguimiento_para_observacion"
                                                               value="0">
                                                        <table id="tabla-observaciones modal-lg" class="table">
                                                            <thead>
                                                            <tr>
                                                                <th>OBSERVACIÓN</th>
                                                                <th>CORREO</th>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <span class=" text-medium opacity-75 text-light">
                                            <i class="md md-message"></i> <?php echo $s->proveido ?>
                                        </span>
                                    </div>
                                </div>
                            </div>
        ...
        <a href="#" class="btn btn-sm btn-warning btn-modal-reclamar" data-toggle="modal"
           title="Reclamos/Consultas/Sugerencias"
