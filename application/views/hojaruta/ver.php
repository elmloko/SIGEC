...
<table id="theTable" class="tablesorter">
    ...
    <tbody>
        ...
        <tr>
            <td><b><a href="/route/trace/?hr=<?php echo $n->nur;?>" title="Ver seguimiento de la hoja de ruta" ><?php echo $n->nur;?></a></b></td>                              
            ...
            <td>
                <a href="/route/trace/?hr=<?php echo $n->nur?>" class="button">VER </a>
            </td>
        </tr>
        <?php endforeach;?>
    </tbody>
