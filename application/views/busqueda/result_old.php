...
<div style="margin: 0 auto; width: 500px;" >
    <fieldset>
        <table>
            <tbody>
                <tr>
                    <td>ENTIDAD REMITENTE: </td><td><?php echo Form::input('entidad_remitente', ''); ?></td><td rowspan="6">Operador: <?php echo Form::select('criterio',array('AND'=>'Y','OR'=>'O'))?></td>
                </tr>
                <tr>
                    <td>HOJA DE RUTA</td><td><?php echo Form::input('entidad_remitente', ''); ?></td>
                </tr>
                <tr>                
                    <td>CITE</td><td><?php echo Form::input('entidad_remitente', ''); ?></td> </tr>
                <tr> 
                    <td>NOMBRE REMITENTE</td><td><?php echo Form::input('entidad_remitente', ''); ?></td> </tr>
                <tr> 
                    <td>CARGO REMITENTE</td><td><?php echo Form::input('entidad_remitente', ''); ?></td> </tr>
                <tr> 
                    <td>NOMBRE DESTINATARIO</td><td><?php echo Form::input('entidad_remitente', ''); ?></td> </tr>
                <tr> 
                    <td>CARGO DESTINATARIO</td><td><?php echo Form::input('entidad_remitente', ''); ?></td> </tr>
                <tr> 
                    <td>REFERENCIA</td><td><?php echo Form::input('entidad_remitente', ''); ?></td> </tr>
                <tr> 
                </tr>
            </tbody>
        </table>
