...
<span style="float:right; padding-right: 5px;">
    <a href="/ventanilla" class="button2"> + Recepcionar nuevo</a>
</span>
</p>
<table id="theTable">
    <thead>
    ...
    foreach ($results as $d): ?>
        <tr>
            ...
            <td class="codigo" align="center">
                <a href="/document/detail/?id=<?php echo $d->id;?>" ><?php echo $d->cite_original;?></a>               
            </td>
            <td>
            ...
            <td style="text-align: right;">
                <?php if($d->estado==1):?>
                <a href="/route/trace/?hr=<?php echo $d->nur;?>" title="Derivar" >Derivado</a>            
                <?php else: ?>
                <a href="/ventanilla/edit/<?php echo $d->id;?>" title="Editar documento" ><img src="/media/images/edit.png"/></a>          
