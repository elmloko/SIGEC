...
<h2 class="subtitulo">Correspondencia Agrupada<br/> <span>Lista de Hojas de Ruta agrupadas.</span></h2>
<?php if($count>0):?> 
...
<?php echo $page_links; ?>
<?php else: ?><div class="info"> 
<p><span style="float: left; margin-right: .3em;" class="ui-icon ui-icon-info"></span>
    <b>Lista Vacia!</b> Usted no tiene correspondencia agrupada.</p>
</div>
<?php endif; ?>