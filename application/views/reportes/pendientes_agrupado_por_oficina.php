<script type="text/javascript">
    $(document).ready(function () {
        ...
        var source =
        {
            ...
            id: 'id',
            url: '/ajax/jsonTotalPendientesAgrupadoPorOficina'
        };
...
//                        {text: 'CUCE SICOES', datafield: 'cuce_proyecto', width: '5%', filtertype: 'textbox', filtercondition: 'contains'},
        ...
        $("#jqxgrid").bind('rowclick', function (event) {
            ...
            var source2 =
            {
                ...
                // id: 'id',
                url: '/ajax/jsonPendientesDeUsuariosAgrupadoPorOficinaId/' + id,
            };
...
<div class="row">
    <div class="col-lg-8">
        <span class="text-xl"><i class="fa fa-inbox"></i> Lista de Pendientes Agrupado por Oficina</span> Para ver en detalle
