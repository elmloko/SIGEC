<script type="text/javascript">
    $(document).ready(function () {
        ...
        function actualizar2() {
            ...
            //$('#statusbarordersGrid').html('Total Pendientes: <b>' +  JSON.stringify(visibleRows)+ '</b>');
        }
        ...
        var source =
        {
            ...
            id: 'id',
            url: '/ajax/jsonTotalPendientesFueraDePlazo'
        };
...
//                        {text: 'CUCE SICOES', datafield: 'cuce_proyecto', width: '5%', filtertype: 'textbox', filtercondition: 'contains'},  
        ...
        //************ 29032016: Cargar por defecto todo el listado al ingresar a la URL del reporte

	/*
        // prepare the data
        var source_todoslospendientes_fueraplazo =
        {
            datatype: "json",
            datafields: [
                {name: 'id'},
            ...
            id: 'id',
            url: '/ajax/jsonTodosLosPendientesFueraDePlazo/'
        };

        var adapter_todoslospendientes_fueraplazo = new $.jqx.dataAdapter(source_todoslospendientes_fueraplazo);
        // update data source.
        $("#ordersGrid").jqxGrid({
            source: adapter_todoslospendientes_fueraplazo
        });
	*/
        //************ 29032016
        ...
        $("#jqxgrid").bind('rowclick', function (event) {
            ...
            var source2 =
            {
                ...
                id: 'id',
                url: '/ajax/jsonPendientesPorUsuarioId/' + id,
            };
        ...
        $("#ordersGrid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    {text: 'GESTION', datafield: 'gestion', width: 100,},
                    {
                        text: 'FECHA EMISION',
                        datafield: 'fecha',
                        width: 130,
...
<div class="row">
    <div class="col-lg-8">
        <span class="text-xl"><i class="fa fa-inbox"></i> Lista de Pendientes/No recibidos </span> Para ver en detalle
