<script type="text/javascript">
    $(document).ready(function () {
        ...
        var source =
        {
            ...
            id: 'id',
            url: '/ajax/jsonPendientesConRetraso'
        };
...
//                        {text: 'CUCE SICOES', datafield: 'cuce_proyecto', width: '5%', filtertype: 'textbox', filtercondition: 'contains'},
        ...
        $("#jqxgrid").bind('rowclick', function (event) {
            ...
            var source2 =
            {
                ...
                id: 'id',
                url: '/ajax/jsonPendientesConRetrasoUserId/' + id,
            };
        ...
        $("#ordersGrid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    {text: 'PRIORIDAD', datafield: 'prioridad', width: 100, filtertype: 'checkedlist'},
                    {text: 'Suma', datafield: 'suma', width: 0, hidden: true},
                    {
                        text: 'VER',
                        width: 200,
