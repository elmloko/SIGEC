        ...
        <table width="100%">        
            <tr>
                <td  valign="top" style=" padding-left: 1px;" rowspan="2">
                    ...
                    <p>
                        <?php
                        echo Form::label('destinatario', 'Nombre del destinatario:', array('class' => 'form', 'index' => '100'));
                        echo Form::input('destinatario', '', array('id' => 'destinatario', 'size' => 48, 'class' => 'required', 'index' => '101'));
                        ?>
                    </p>
                    <p>
                        <?php
                        echo Form::label('destinatario', 'Cargo Destinatario:', array('class' => 'form', 'index' => '102'));
                        echo Form::input('cargo_des', '', array('id' => 'cargo_des', 'size' => 48, 'class' => 'required', 'index' => '103'));
                        ?>
                    </p>   
                    <?php if ($tipo->via == 0): ?>
                        <p>
